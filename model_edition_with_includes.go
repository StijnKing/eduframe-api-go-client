...
// checks if the EditionWithIncludes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EditionWithIncludes{}

// EditionWithIncludes struct for EditionWithIncludes
type EditionWithIncludes struct {
...
type _EditionWithIncludes EditionWithIncludes
...
func (o EditionWithIncludes) MarshalJSON() ([]byte, error) {
...
func (o EditionWithIncludes) ToMap() (map[string]interface{}, error) {
...
func (o *EditionWithIncludes) UnmarshalJSON(data []byte) (err error) {
	...
	varEditionWithIncludes := _EditionWithIncludes{}

	err = json.Unmarshal(data, &varEditionWithIncludes)

	if err != nil {
		return err
	}

	*o = EditionWithIncludes(varEditionWithIncludes)
...
type NullableEditionWithIncludes struct {
	value *EditionWithIncludes
	isSet bool
}

func (v NullableEditionWithIncludes) Get() *EditionWithIncludes {
	return v.value
}

func (v *NullableEditionWithIncludes) Set(val *EditionWithIncludes) {
	v.value = val
	v.isSet = true
}

func (v NullableEditionWithIncludes) IsSet() bool {
	return v.isSet
}

func (v *NullableEditionWithIncludes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEditionWithIncludes(val *EditionWithIncludes) *NullableEditionWithIncludes {
	return &NullableEditionWithIncludes{value: val, isSet: true}
}

func (v NullableEditionWithIncludes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEditionWithIncludes) UnmarshalJSON(src []byte) error {
	v.isSet = true
