...
// checks if the LeadWithIncludes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LeadWithIncludes{}

// LeadWithIncludes struct for LeadWithIncludes
type LeadWithIncludes struct {
	...
	LeadProducts []LeadProduct `json:"lead_products,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _LeadWithIncludes LeadWithIncludes
...
func (o *LeadWithIncludes) SetAddressNil() {
	o.Address.Set(nil)
}
...
// SetLeadProducts gets a reference to the given []LeadProduct and assigns it to the LeadProducts field.
func (o *LeadWithIncludes) SetLeadProducts(v []LeadProduct) {
	o.LeadProducts = v
}

func (o LeadWithIncludes) MarshalJSON() ([]byte, error) {
...
func (o LeadWithIncludes) ToMap() (map[string]interface{}, error) {
...
func (o *LeadWithIncludes) UnmarshalJSON(data []byte) (err error) {
	...
	varLeadWithIncludes := _LeadWithIncludes{}

	err = json.Unmarshal(data, &varLeadWithIncludes)

	if err != nil {
		return err
	}

	*o = LeadWithIncludes(varLeadWithIncludes)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "id")
		delete(additionalProperties, "creation_method")
		delete(additionalProperties, "referral_text")
...
type NullableLeadWithIncludes struct {
	value *LeadWithIncludes
	isSet bool
}

func (v NullableLeadWithIncludes) Get() *LeadWithIncludes {
	return v.value
}

func (v *NullableLeadWithIncludes) Set(val *LeadWithIncludes) {
	v.value = val
	v.isSet = true
}

func (v NullableLeadWithIncludes) IsSet() bool {
	return v.isSet
}

func (v *NullableLeadWithIncludes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLeadWithIncludes(val *LeadWithIncludes) *NullableLeadWithIncludes {
	return &NullableLeadWithIncludes{value: val, isSet: true}
}

func (v NullableLeadWithIncludes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLeadWithIncludes) UnmarshalJSON(src []byte) error {
	v.isSet = true
