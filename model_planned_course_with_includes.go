...
// checks if the PlannedCourseWithIncludes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PlannedCourseWithIncludes{}

// PlannedCourseWithIncludes struct for PlannedCourseWithIncludes
type PlannedCourseWithIncludes struct {
...
type _PlannedCourseWithIncludes PlannedCourseWithIncludes
...
func NewPlannedCourseWithIncludes(id int32, status PlannedCourseStatus, durationInDays NullableInt32, availabilityState AvailabilityState, payable bool, currentParticipants int32, confirmedActiveAndCompletedEnrollmentsCount int32, requestedEnrollmentsCount int32, availablePlaces bool, currency Currency, costMultiplier NullableString, isPublished bool, courseId int32, type_ string, startDate string, endDate NullableString, minParticipants NullableInt32, maxParticipants NullableInt32, costScheme CostScheme, cost NullableString, courseVariantId NullableInt32, courseLocationId NullableInt32, updatedAt time.Time, createdAt time.Time) *PlannedCourseWithIncludes {
	this := PlannedCourseWithIncludes{}
	this.Id = id
	this.Status = status
...
func (o *PlannedCourseWithIncludes) SetCanvasLinkNil() {
...
func (o PlannedCourseWithIncludes) MarshalJSON() ([]byte, error) {
...
func (o PlannedCourseWithIncludes) ToMap() (map[string]interface{}, error) {
...
func (o *PlannedCourseWithIncludes) UnmarshalJSON(data []byte) (err error) {
	...
	varPlannedCourseWithIncludes := _PlannedCourseWithIncludes{}

	err = json.Unmarshal(data, &varPlannedCourseWithIncludes)

	if err != nil {
		return err
	}

	*o = PlannedCourseWithIncludes(varPlannedCourseWithIncludes)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "duration_in_days")
		delete(additionalProperties, "availability_state")
		delete(additionalProperties, "payable")
		delete(additionalProperties, "current_participants")
		delete(additionalProperties, "confirmed_active_and_completed_enrollments_count")
		delete(additionalProperties, "requested_enrollments_count")
		delete(additionalProperties, "available_places")
		delete(additionalProperties, "canvas_link")
...
type NullablePlannedCourseWithIncludes struct {
	value *PlannedCourseWithIncludes
	isSet bool
}

func (v NullablePlannedCourseWithIncludes) Get() *PlannedCourseWithIncludes {
	return v.value
}

func (v *NullablePlannedCourseWithIncludes) Set(val *PlannedCourseWithIncludes) {
	v.value = val
	v.isSet = true
}

func (v NullablePlannedCourseWithIncludes) IsSet() bool {
	return v.isSet
}

func (v *NullablePlannedCourseWithIncludes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePlannedCourseWithIncludes(val *PlannedCourseWithIncludes) *NullablePlannedCourseWithIncludes {
	return &NullablePlannedCourseWithIncludes{value: val, isSet: true}
}

func (v NullablePlannedCourseWithIncludes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePlannedCourseWithIncludes) UnmarshalJSON(src []byte) error {
	v.isSet = true
