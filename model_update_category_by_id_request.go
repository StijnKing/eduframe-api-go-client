...
// checks if the UpdateCategoryByIdRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateCategoryByIdRequest{}

// UpdateCategoryByIdRequest struct for UpdateCategoryByIdRequest
...
type _UpdateCategoryByIdRequest UpdateCategoryByIdRequest
...
func NewUpdateCategoryByIdRequest() *UpdateCategoryByIdRequest {
	this := UpdateCategoryByIdRequest{}
	return &this
}
...
func (o *UpdateCategoryByIdRequest) SetDescriptionNil() {
...
func (o *UpdateCategoryByIdRequest) SetMetaTitleNil() {
	o.MetaTitle.Set(nil)
}
...
func (o *UpdateCategoryByIdRequest) SetMetaDescriptionNil() {
...
func (o *UpdateCategoryByIdRequest) SetParentIdNil() {
	o.ParentId.Set(nil)
}
...
func (o UpdateCategoryByIdRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateCategoryByIdRequest) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateCategoryByIdRequest) UnmarshalJSON(data []byte) (err error) {
	varUpdateCategoryByIdRequest := _UpdateCategoryByIdRequest{}

	err = json.Unmarshal(data, &varUpdateCategoryByIdRequest)

	if err != nil {
		return err
	}

	*o = UpdateCategoryByIdRequest(varUpdateCategoryByIdRequest)
...
type NullableUpdateCategoryByIdRequest struct {
	value *UpdateCategoryByIdRequest
	isSet bool
}

func (v NullableUpdateCategoryByIdRequest) Get() *UpdateCategoryByIdRequest {
	return v.value
}

func (v *NullableUpdateCategoryByIdRequest) Set(val *UpdateCategoryByIdRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateCategoryByIdRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateCategoryByIdRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateCategoryByIdRequest(val *UpdateCategoryByIdRequest) *NullableUpdateCategoryByIdRequest {
	return &NullableUpdateCategoryByIdRequest{value: val, isSet: true}
}

func (v NullableUpdateCategoryByIdRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateCategoryByIdRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
